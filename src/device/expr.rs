...
#[doc(hidden)]
pub struct SoVA1<Source> {
    pub(crate) source: Source,
}

#[doc(hidden)]
pub struct SoVA2<Left, Right> {
    pub(crate) left: Left,
    pub(crate) right: Right,
}
...
#[doc(hidden)]
pub struct SoVA3<First, Second, Third> {
    pub(crate) first: First,
    pub(crate) second: Second,
    pub(crate) third: Third,
}
...
macro_rules! define_device_sova {
    ($name:ident < $first:ident, $( $rest:ident ),+ > { $first_field:ident, $( $field:ident ),+ }) => {
        ...
        impl<$first, $( $rest ),+> SoVA for $name<$first, $( $rest ),+>
        where
            $first: KernelColumn + SoVA<Runtime = <$first as KernelColumn>::Runtime, Item = <$first as KernelColumn>::Item>,
            $(
...
define_device_sova!(SoVA4<A, B, C, D> { a, b, c, d });
define_device_sova!(SoVA5<A, B, C, D, E> { a, b, c, d, e });
define_device_sova!(SoVA6<A, B, C, D, E, F> { a, b, c, d, e, f });
define_device_sova!(SoVA7<A, B, C, D, E, F, G> { a, b, c, d, e, f, g });
define_device_sova!(SoVA8<A, B, C, D, E, F, G, H> { a, b, c, d, e, f, g, h });
define_device_sova!(SoVA9<A, B, C, D, E, F, G, H, I> { a, b, c, d, e, f, g, h, i });
define_device_sova!(SoVA10<A, B, C, D, E, F, G, H, I, J> { a, b, c, d, e, f, g, h, i, j });
define_device_sova!(SoVA11<A, B, C, D, E, F, G, H, I, J, K> { a, b, c, d, e, f, g, h, i, j, k });
define_device_sova!(SoVA12<A, B, C, D, E, F, G, H, I, J, K, L> { a, b, c, d, e, f, g, h, i, j, k, l });
...
impl<Left, Right> SoVA for SoVA2<Left, Right>
where
    Left: KernelColumn
        + KernelColumnAt<S0>
        + SoVA<Runtime = <Left as KernelColumn>::Runtime, Item = <Left as KernelColumn>::Item>,
...
impl<Source> SoVA for SoVA1<Source>
where
...
impl<First, Second, Third> SoVA for SoVA3<First, Second, Third>
where
    First: KernelColumn
        + KernelColumnAt<S0>
        + SoVA<Runtime = <First as KernelColumn>::Runtime, Item = <First as KernelColumn>::Item>,
