use crate::{
    device::{
        DeviceVec, KernelColumn, KernelColumnAt, S0, SoA2, SoA3, SoA4, SoA5, SoA6, SoA7, SoA8,
        SoA9, SoA10, SoA11, SoA12, SoVA, SoVA1, SoVA2, SoVA3, SoVA4, SoVA5, SoVA6, SoVA7, SoVA8,
        SoVA9, SoVA10, SoVA11, SoVA12,
    },
    error::Error,
    expr::DeviceGpuExpr,
    kernels::*,
...
macro_rules! impl_tuple_pair_search {
    (
        ...
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            $name<$right_first, $( $right_rest ),+>: SoVA<Scalar = <$right_first as KernelColumn>::Item>,
            $first: KernelColumn + KernelColumnAt<S0>,
            ...
            )>,
        {
            fn equal_input(
                ...
                if SoVA::len(&self) != SoVA::len(&other) {
                    return Ok(false);
                }
