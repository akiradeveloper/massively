...
impl<Source, Op> AdjacentDifferenceInput<Op> for SoVA1<Source>
where
    Self: SoVA<Item = Source::Item, Scalar = Source::Item>,
    Source: KernelColumn + KernelColumnAt<S0>,
    Source::Item: CubePrimitive + CubeElement,
...
impl_adjacent_difference_input!(SoVA2 -> SoA2<A, B> { left, right });
impl_adjacent_difference_input!(SoVA3 -> SoA3<A, B, C> { first, second, third });
impl_adjacent_difference_input!(SoVA4 -> SoA4<A, B, C, D> { a, b, c, d });
impl_adjacent_difference_input!(SoVA5 -> SoA5<A, B, C, D, E> { a, b, c, d, e });
impl_adjacent_difference_input!(SoVA6 -> SoA6<A, B, C, D, E, F> { a, b, c, d, e, f });
impl_adjacent_difference_input!(SoVA7 -> SoA7<A, B, C, D, E, F, G> { a, b, c, d, e, f, g });
impl_adjacent_difference_input!(SoVA8 -> SoA8<A, B, C, D, E, F, G, H> { a, b, c, d, e, f, g, h });
impl_adjacent_difference_input!(SoVA9 -> SoA9<A, B, C, D, E, F, G, H, I> { a, b, c, d, e, f, g, h, i });
impl_adjacent_difference_input!(SoVA10 -> SoA10<A, B, C, D, E, F, G, H, I, J> { a, b, c, d, e, f, g, h, i, j });
impl_adjacent_difference_input!(SoVA11 -> SoA11<A, B, C, D, E, F, G, H, I, J, K> { a, b, c, d, e, f, g, h, i, j, k });
impl_adjacent_difference_input!(SoVA12 -> SoA12<A, B, C, D, E, F, G, H, I, J, K, L> { a, b, c, d, e, f, g, h, i, j, k, l });
...
impl<ValueA, ValueB, KeyA, KeyB, KeyEq, Op> InclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
    for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
    SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
    KeyA: KernelColumn + KernelColumnAt<S0>,
    KeyB: KernelColumn<Runtime = KeyA::Runtime> + KernelColumnAt<S0>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyEq, Op>
    InclusiveScanByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
    SoVA3<ValueA, ValueB, ValueC>:
        SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
    KeyA: KernelColumn + KernelColumnAt<S0>,
    KeyB: KernelColumn<Runtime = KeyA::Runtime> + KernelColumnAt<S0>,
    ValueA: KernelColumn<Runtime = KeyA::Runtime> + KernelColumnAt<S0>,
    ValueB: KernelColumn<Runtime = KeyA::Runtime> + KernelColumnAt<S0>,
    ...
    Op: BinaryOp<ValueC::Item>,
{
    ...
    fn inclusive_scan_by_key_call(
        self,
        values: SoVA3<ValueA, ValueB, ValueC>,
        _key_eq: GpuOp<KeyEq>,
        _op: GpuOp<Op>,
    ) -> Result<Self::Output, Error> {
        SoVA::validate(&self)?;
...
impl<ValueA, ValueB, KeyA, KeyB, KeyC, KeyEq, Op>
    InclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op> for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
    KeyA: KernelColumn + KernelColumnAt<S0>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyC, KeyEq, Op>
    InclusiveScanByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA3<ValueA, ValueB, ValueC>:
        SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
...
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA4, inclusive_scan_tuple4_by_key_device_vec, (A: a, B: b, C: c, D: d));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA5, inclusive_scan_tuple5_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA6, inclusive_scan_tuple6_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA7, inclusive_scan_tuple7_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA8, inclusive_scan_tuple8_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA9, inclusive_scan_tuple9_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA10, inclusive_scan_tuple10_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA11, inclusive_scan_tuple11_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k));
impl_inclusive_scan_by_tuple_key_scalar_value!(SoVA12, inclusive_scan_tuple12_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k, L: l));
...
macro_rules! impl_inclusive_scan_by_tuple_key_sova2_values {
    (
        $keys:ident,
        $scan_fn:ident,
        ( $first:ident: $first_field:ident, $( $key:ident: $field:ident ),+ )
        ...
        impl<ValueA, ValueB, $first, $( $key ),+, KeyEq, Op>
            InclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
            for $keys<$first, $( $key ),+>
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
...
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA4, inclusive_scan_tuple4_by_key_device_vec, (A: a, B: b, C: c, D: d));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA5, inclusive_scan_tuple5_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA6, inclusive_scan_tuple6_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA7, inclusive_scan_tuple7_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA8, inclusive_scan_tuple8_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA9, inclusive_scan_tuple9_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA10, inclusive_scan_tuple10_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA11, inclusive_scan_tuple11_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k));
impl_inclusive_scan_by_tuple_key_sova2_values!(SoVA12, inclusive_scan_tuple12_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k, L: l));

macro_rules! impl_inclusive_scan_by_tuple_key_sova3_values {
    (
        $keys:ident,
        $scan_fn:ident,
        ( $first:ident: $first_field:ident, $( $key:ident: $field:ident ),+ )
        ...
        impl<ValueA, ValueB, ValueC, $first, $( $key ),+, KeyEq, Op>
            InclusiveScanByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op>
            for $keys<$first, $( $key ),+>
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            SoVA3<ValueA, ValueB, ValueC>:
...
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA4, inclusive_scan_tuple4_by_key_device_vec, (A: a, B: b, C: c, D: d));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA5, inclusive_scan_tuple5_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA6, inclusive_scan_tuple6_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA7, inclusive_scan_tuple7_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA8, inclusive_scan_tuple8_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA9, inclusive_scan_tuple9_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA10, inclusive_scan_tuple10_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA11, inclusive_scan_tuple11_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k));
impl_inclusive_scan_by_tuple_key_sova3_values!(SoVA12, inclusive_scan_tuple12_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k, L: l));

macro_rules! impl_inclusive_scan_by_tuple_key_sova_values {
    ...
    (@scan_values $scan_fn:ident, ($first_field:ident, $( $field:ident ),+), $value_field:ident $(, $tail:ident )*) => {
        let $value_field = impl_inclusive_scan_by_tuple_key_sova_values!(
            @scan $scan_fn,
            ($first_field, $( $field ),+),
            $value_field
        )?;
        impl_inclusive_scan_by_tuple_key_sova_values!(
            @scan_values $scan_fn,
            ($first_field, $( $field ),+),
            $( $tail ),*
        );
    ...
    (
            ...
            $( Op: BinaryOp<<$value as KernelColumn>::Item>, )+
        {
            ...
            fn inclusive_scan_by_key_call(
                ...
                let $first_value_field = impl_inclusive_scan_by_tuple_key_sova_values!(
                    @scan $scan_fn,
                    ($first_field, $( $field ),+),
                    $first_value_field
                )?;
...
macro_rules! impl_inclusive_scan_by_tuple_key_sova_values_for_key {
    ($key_storage:ident, $keys:ident, $scan_fn:ident, ( $first:ident: $first_field:ident, $( $key:ident: $field:ident ),+ )) => {
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA4 -> SoA4<A, B, C, D> { a, b, c, d }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA5 -> SoA5<A, B, C, D, E> { a, b, c, d, e }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA6 -> SoA6<A, B, C, D, E, F> { a, b, c, d, e, f }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA7 -> SoA7<A, B, C, D, E, F, G> { a, b, c, d, e, f, g }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA8 -> SoA8<A, B, C, D, E, F, G, H> { a, b, c, d, e, f, g, h }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA9 -> SoA9<A, B, C, D, E, F, G, H, I> { a, b, c, d, e, f, g, h, i }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA10 -> SoA10<A, B, C, D, E, F, G, H, I, J> { a, b, c, d, e, f, g, h, i, j }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA11 -> SoA11<A, B, C, D, E, F, G, H, I, J, K> { a, b, c, d, e, f, g, h, i, j, k }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA12 -> SoA12<A, B, C, D, E, F, G, H, I, J, K, L> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA2 -> SoA2<A, B> { left, right }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA3 -> SoA3<A, B, C> { first, second, third }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA4 -> SoA4<A, B, C, D> { a, b, c, d }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA5 -> SoA5<A, B, C, D, E> { a, b, c, d, e }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA6 -> SoA6<A, B, C, D, E, F> { a, b, c, d, e, f }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA7 -> SoA7<A, B, C, D, E, F, G> { a, b, c, d, e, f, g }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA8 -> SoA8<A, B, C, D, E, F, G, H> { a, b, c, d, e, f, g, h }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA9 -> SoA9<A, B, C, D, E, F, G, H, I> { a, b, c, d, e, f, g, h, i }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA10 -> SoA10<A, B, C, D, E, F, G, H, I, J> { a, b, c, d, e, f, g, h, i, j }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA11 -> SoA11<A, B, C, D, E, F, G, H, I, J, K> { a, b, c, d, e, f, g, h, i, j, k }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_inclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA12 -> SoA12<A, B, C, D, E, F, G, H, I, J, K, L> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
    };
}

impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA2, inclusive_scan_tuple2_by_key_device_vec, (KA: left, KB: right));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA3, inclusive_scan_tuple3_by_key_device_vec, (KA: first, KB: second, KC: third));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA4, inclusive_scan_tuple4_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA5, inclusive_scan_tuple5_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA6, inclusive_scan_tuple6_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA7, inclusive_scan_tuple7_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA8, inclusive_scan_tuple8_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA9, inclusive_scan_tuple9_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA10, inclusive_scan_tuple10_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA11, inclusive_scan_tuple11_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA12, inclusive_scan_tuple12_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k, KL: l));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA2, inclusive_scan_tuple2_by_key_device_vec, (KA: left, KB: right));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA3, inclusive_scan_tuple3_by_key_device_vec, (KA: first, KB: second, KC: third));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA4, inclusive_scan_tuple4_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA5, inclusive_scan_tuple5_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA6, inclusive_scan_tuple6_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA7, inclusive_scan_tuple7_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA8, inclusive_scan_tuple8_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA9, inclusive_scan_tuple9_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA10, inclusive_scan_tuple10_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA11, inclusive_scan_tuple11_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k));
impl_inclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA12, inclusive_scan_tuple12_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k, KL: l));
...
impl<ValueA, ValueB, KeyA, KeyB, KeyEq, Op> ExclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
    for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
    SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyEq, Op>
    ExclusiveScanByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
    SoVA3<ValueA, ValueB, ValueC>:
        SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
...
impl<ValueA, ValueB, KeyA, KeyB, KeyC, KeyEq, Op>
    ExclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op> for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
    KeyA: KernelColumn + KernelColumnAt<S0>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyC, KeyEq, Op>
    ExclusiveScanByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA3<ValueA, ValueB, ValueC>:
        SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
...
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA4, exclusive_scan_tuple4_by_key_device_vec, (A: a, B: b, C: c, D: d));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA5, exclusive_scan_tuple5_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA6, exclusive_scan_tuple6_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA7, exclusive_scan_tuple7_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA8, exclusive_scan_tuple8_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA9, exclusive_scan_tuple9_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA10, exclusive_scan_tuple10_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA11, exclusive_scan_tuple11_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k));
impl_exclusive_scan_by_tuple_key_scalar_value!(SoVA12, exclusive_scan_tuple12_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k, L: l));
...
macro_rules! impl_exclusive_scan_by_tuple_key_sova2_values {
    (
        $keys:ident,
        $scan_fn:ident,
        ( $first:ident: $first_field:ident, $( $key:ident: $field:ident ),+ )
        ...
        impl<ValueA, ValueB, $first, $( $key ),+, KeyEq, Op>
            ExclusiveScanByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
            for $keys<$first, $( $key ),+>
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
...
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA4, exclusive_scan_tuple4_by_key_device_vec, (A: a, B: b, C: c, D: d));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA5, exclusive_scan_tuple5_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA6, exclusive_scan_tuple6_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA7, exclusive_scan_tuple7_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA8, exclusive_scan_tuple8_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA9, exclusive_scan_tuple9_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA10, exclusive_scan_tuple10_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA11, exclusive_scan_tuple11_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k));
impl_exclusive_scan_by_tuple_key_sova2_values!(SoVA12, exclusive_scan_tuple12_by_key_device_vec, (A: a, B: b, C: c, D: d, E: e, F: f, G: g, H: h, I: i, J: j, K: k, L: l));

macro_rules! impl_exclusive_scan_by_tuple_key_sova_values {
    ...
    (@scan_values $scan_fn:ident, ($first_field:ident, $( $field:ident ),+), $init:ident, $value_field:ident: $idx:tt $(, $tail_field:ident: $tail_idx:tt )*) => {
        let $value_field = impl_exclusive_scan_by_tuple_key_sova_values!(
            @scan $scan_fn,
            ($first_field, $( $field ),+),
            $value_field,
            $init.$idx
        )?;
        impl_exclusive_scan_by_tuple_key_sova_values!(
            @scan_values $scan_fn,
            ($first_field, $( $field ),+),
            $init,
            $( $tail_field: $tail_idx ),*
    ...
    (
            ...
            $( Op: BinaryOp<<$value as KernelColumn>::Item>, )+
        {
            ...
            fn exclusive_scan_by_key_call(
                ...
                let $first_value_field = super::device_expr_collect(&values.$first_value_field)?;
                $( let $value_field = super::device_expr_collect(&values.$value_field)?; )+
                let $first_value_field = impl_exclusive_scan_by_tuple_key_sova_values!(
                    @scan $scan_fn,
                    ($first_field, $( $field ),+),
                    $first_value_field,
                    init.$first_idx
...
macro_rules! impl_exclusive_scan_by_tuple_key_sova_values_for_key {
    ($key_storage:ident, $keys:ident, $scan_fn:ident, ( $first:ident: $first_field:ident, $( $key:ident: $field:ident ),+ )) => {
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA4 -> SoA4<A: 0, B: 1, C: 2, D: 3> { a, b, c, d }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA5 -> SoA5<A: 0, B: 1, C: 2, D: 3, E: 4> { a, b, c, d, e }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA6 -> SoA6<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5> { a, b, c, d, e, f }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA7 -> SoA7<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6> { a, b, c, d, e, f, g }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA8 -> SoA8<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7> { a, b, c, d, e, f, g, h }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA9 -> SoA9<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8> { a, b, c, d, e, f, g, h, i }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA10 -> SoA10<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9> { a, b, c, d, e, f, g, h, i, j }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA11 -> SoA11<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10> { a, b, c, d, e, f, g, h, i, j, k }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoVA, SoVA12 -> SoA12<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10, L: 11> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA2 -> SoA2<A: 0, B: 1> { left, right }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA3 -> SoA3<A: 0, B: 1, C: 2> { first, second, third }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA4 -> SoA4<A: 0, B: 1, C: 2, D: 3> { a, b, c, d }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA5 -> SoA5<A: 0, B: 1, C: 2, D: 3, E: 4> { a, b, c, d, e }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA6 -> SoA6<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5> { a, b, c, d, e, f }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA7 -> SoA7<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6> { a, b, c, d, e, f, g }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA8 -> SoA8<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7> { a, b, c, d, e, f, g, h }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA9 -> SoA9<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8> { a, b, c, d, e, f, g, h, i }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA10 -> SoA10<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9> { a, b, c, d, e, f, g, h, i, j }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA11 -> SoA11<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10> { a, b, c, d, e, f, g, h, i, j, k }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
        impl_exclusive_scan_by_tuple_key_sova_values!($key_storage, SoA, SoA12 -> SoA12<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10, L: 11> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys, $scan_fn, ( $first: $first_field, $( $key: $field ),+ ));
    };
}

impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA2, exclusive_scan_tuple2_by_key_device_vec, (KA: left, KB: right));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA3, exclusive_scan_tuple3_by_key_device_vec, (KA: first, KB: second, KC: third));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA4, exclusive_scan_tuple4_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA5, exclusive_scan_tuple5_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA6, exclusive_scan_tuple6_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA7, exclusive_scan_tuple7_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA8, exclusive_scan_tuple8_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA9, exclusive_scan_tuple9_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA10, exclusive_scan_tuple10_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA11, exclusive_scan_tuple11_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoVA, SoVA12, exclusive_scan_tuple12_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k, KL: l));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA2, exclusive_scan_tuple2_by_key_device_vec, (KA: left, KB: right));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA3, exclusive_scan_tuple3_by_key_device_vec, (KA: first, KB: second, KC: third));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA4, exclusive_scan_tuple4_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA5, exclusive_scan_tuple5_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA6, exclusive_scan_tuple6_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA7, exclusive_scan_tuple7_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA8, exclusive_scan_tuple8_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA9, exclusive_scan_tuple9_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA10, exclusive_scan_tuple10_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA11, exclusive_scan_tuple11_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k));
impl_exclusive_scan_by_tuple_key_sova_values_for_key!(SoA, SoA12, exclusive_scan_tuple12_by_key_device_vec, (KA: a, KB: b, KC: c, KD: d, KE: e, KF: f, KG: g, KH: h, KI: i, KJ: j, KK: k, KL: l));
