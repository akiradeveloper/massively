...
use crate::{
    device::{
        DeviceBinaryMap, DeviceVec, KernelColumn, KernelColumnAt, S0, SoA, SoA1, SoA2, SoA3, SoA4,
...
macro_rules! impl_inner_product_tuple_input {
    (
        ...
        where
            ...
            $right_name<$first_right, $( $right ),+>: SoVA<Scalar = <$first_right as KernelColumn>::Item>,
...
impl_inner_product_tuple_input!(SoVA2<A, B>, SoVA2<RA, RB> { left, right });
impl_inner_product_tuple_input!(SoVA3<A, B, C>, SoVA3<RA, RB, RC> { first, second, third });
impl_inner_product_tuple_input!(SoVA4<A, B, C, D>, SoVA4<RA, RB, RC, RD> { a, b, c, d });
impl_inner_product_tuple_input!(SoVA5<A, B, C, D, E>, SoVA5<RA, RB, RC, RD, RE> { a, b, c, d, e });
impl_inner_product_tuple_input!(SoVA6<A, B, C, D, E, F>, SoVA6<RA, RB, RC, RD, RE, RF> { a, b, c, d, e, f });
impl_inner_product_tuple_input!(SoVA7<A, B, C, D, E, F, G>, SoVA7<RA, RB, RC, RD, RE, RF, RG> { a, b, c, d, e, f, g });
impl_inner_product_tuple_input!(SoVA8<A, B, C, D, E, F, G, H>, SoVA8<RA, RB, RC, RD, RE, RF, RG, RH> { a, b, c, d, e, f, g, h });
impl_inner_product_tuple_input!(SoVA9<A, B, C, D, E, F, G, H, I>, SoVA9<RA, RB, RC, RD, RE, RF, RG, RH, RI> { a, b, c, d, e, f, g, h, i });
impl_inner_product_tuple_input!(SoVA10<A, B, C, D, E, F, G, H, I, J>, SoVA10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> { a, b, c, d, e, f, g, h, i, j });
impl_inner_product_tuple_input!(SoVA11<A, B, C, D, E, F, G, H, I, J, K>, SoVA11<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ, RK> { a, b, c, d, e, f, g, h, i, j, k });
impl_inner_product_tuple_input!(SoVA12<A, B, C, D, E, F, G, H, I, J, K, L>, SoVA12<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ, RK, RL> { a, b, c, d, e, f, g, h, i, j, k, l });
...
macro_rules! impl_inner_product_mixed_tuple_inputs {
    (
        ...
        $sova:ident < $first_right:ident, $( $right:ident ),+ > {
            $first_field:ident, $( $field:ident ),+
        }
    ) => {
...
impl_inner_product_mixed_tuple_inputs!(SoA2<A, B>, SoVA2<RA, RB> { left, right });
impl_inner_product_mixed_tuple_inputs!(SoA3<A, B, C>, SoVA3<RA, RB, RC> { first, second, third });
impl_inner_product_mixed_tuple_inputs!(SoA4<A, B, C, D>, SoVA4<RA, RB, RC, RD> { a, b, c, d });
impl_inner_product_mixed_tuple_inputs!(SoA5<A, B, C, D, E>, SoVA5<RA, RB, RC, RD, RE> { a, b, c, d, e });
impl_inner_product_mixed_tuple_inputs!(SoA6<A, B, C, D, E, F>, SoVA6<RA, RB, RC, RD, RE, RF> { a, b, c, d, e, f });
impl_inner_product_mixed_tuple_inputs!(SoA7<A, B, C, D, E, F, G>, SoVA7<RA, RB, RC, RD, RE, RF, RG> { a, b, c, d, e, f, g });
impl_inner_product_mixed_tuple_inputs!(SoA8<A, B, C, D, E, F, G, H>, SoVA8<RA, RB, RC, RD, RE, RF, RG, RH> { a, b, c, d, e, f, g, h });
impl_inner_product_mixed_tuple_inputs!(SoA9<A, B, C, D, E, F, G, H, I>, SoVA9<RA, RB, RC, RD, RE, RF, RG, RH, RI> { a, b, c, d, e, f, g, h, i });
impl_inner_product_mixed_tuple_inputs!(SoA10<A, B, C, D, E, F, G, H, I, J>, SoVA10<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ> { a, b, c, d, e, f, g, h, i, j });
impl_inner_product_mixed_tuple_inputs!(SoA11<A, B, C, D, E, F, G, H, I, J, K>, SoVA11<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ, RK> { a, b, c, d, e, f, g, h, i, j, k });
impl_inner_product_mixed_tuple_inputs!(SoA12<A, B, C, D, E, F, G, H, I, J, K, L>, SoVA12<RA, RB, RC, RD, RE, RF, RG, RH, RI, RJ, RK, RL> { a, b, c, d, e, f, g, h, i, j, k, l });
...
impl<Source, K, KeyEq, Op> ReduceByKeyInput<K, KeyEq, Op> for SoVA1<Source>
where
    Self: SoVA<Item = Source::Item, Scalar = Source::Item>,
    Source: KernelColumn + KernelColumnAt<S0>,
...
where
    Source: KernelColumn + KernelColumnAt<S0>,
    SoVA1<Source>: ReduceByKeyInput<K, KeyEq, Op>,
    K: CubePrimitive + CubeElement,
    KeyEq: BinaryPredicateOp<K>,
{
    type Runtime = <SoVA1<Source> as ReduceByKeyInput<K, KeyEq, Op>>::Runtime;
    type Values = <SoVA1<Source> as ReduceByKeyInput<K, KeyEq, Op>>::Values;
    type Init = <SoVA1<Source> as ReduceByKeyInput<K, KeyEq, Op>>::Init;
    ...
    fn reduce_by_key_input(
        ...
        <SoVA1<Source> as ReduceByKeyInput<K, KeyEq, Op>>::reduce_by_key_input(
            SoVA1 { source: self },
            keys,
            init,
            op,
...
impl<Left, Right, K, KeyEq, Op> ReduceByKeyInput<K, KeyEq, Op> for SoVA2<Left, Right>
where
    Left: KernelColumn + KernelColumnAt<S0>,
...
impl<ValueA, ValueB, KeyA, KeyB, KeyEq, Op> ReduceByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
    for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyEq, Op>
    ReduceByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA2<KeyA, KeyB>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item), Scalar = KeyA::Item>,
...
impl<ValueA, ValueB, KeyA, KeyB, KeyC, KeyEq, Op> ReduceByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op>
    for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
...
impl<ValueA, ValueB, ValueC, KeyA, KeyB, KeyC, KeyEq, Op>
    ReduceByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for SoVA3<KeyA, KeyB, KeyC>
where
    Self: SoVA<Item = (KeyA::Item, KeyB::Item, KeyC::Item), Scalar = KeyA::Item>,
    SoVA3<ValueA, ValueB, ValueC>:
        SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
...
impl_reduce_by_tuple_key_scalar_value!(SoVA4 -> SoA4, reduce_tuple4_by_key_device_vec, Tuple4Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d));
impl_reduce_by_tuple_key_scalar_value!(SoVA5 -> SoA5, reduce_tuple5_by_key_device_vec, Tuple5Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e));
impl_reduce_by_tuple_key_scalar_value!(SoVA6 -> SoA6, reduce_tuple6_by_key_device_vec, Tuple6Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f));
impl_reduce_by_tuple_key_scalar_value!(SoVA7 -> SoA7, reduce_tuple7_by_key_device_vec, Tuple7Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g));
impl_reduce_by_tuple_key_scalar_value!(SoVA8 -> SoA8, reduce_tuple8_by_key_device_vec, Tuple8Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h));
impl_reduce_by_tuple_key_scalar_value!(SoVA9 -> SoA9, reduce_tuple9_by_key_device_vec, Tuple9Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i));
impl_reduce_by_tuple_key_scalar_value!(SoVA10 -> SoA10, reduce_tuple10_by_key_device_vec, Tuple10Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j));
impl_reduce_by_tuple_key_scalar_value!(SoVA11 -> SoA11, reduce_tuple11_by_key_device_vec, Tuple11Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k));
impl_reduce_by_tuple_key_scalar_value!(SoVA12 -> SoA12, reduce_tuple12_by_key_device_vec, Tuple12Equal, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k, L: l: out_l));
...
macro_rules! impl_reduce_by_tuple_key_sova2_values {
    (
        $keys:ident -> $out_keys:ident,
        $reduce_fn:ident,
        $eq:ident,
        ...
        impl<ValueA, ValueB, $first, $( $key ),+, KeyEq, Op>
            ReduceByKeyCall<SoVA2<ValueA, ValueB>, KeyEq, Op> for $keys<$first, $( $key ),+>
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            SoVA2<ValueA, ValueB>: SoVA<Item = (ValueA::Item, ValueB::Item), Scalar = ValueA::Item>,
            $first: KernelColumn + KernelColumnAt<S0>,
...
impl_reduce_by_tuple_key_sova2_values!(SoVA4 -> SoA4, reduce_tuple4_by_key_device_vec, Tuple4Equal, 4, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d));
impl_reduce_by_tuple_key_sova2_values!(SoVA5 -> SoA5, reduce_tuple5_by_key_device_vec, Tuple5Equal, 5, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e));
impl_reduce_by_tuple_key_sova2_values!(SoVA6 -> SoA6, reduce_tuple6_by_key_device_vec, Tuple6Equal, 6, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f));
impl_reduce_by_tuple_key_sova2_values!(SoVA7 -> SoA7, reduce_tuple7_by_key_device_vec, Tuple7Equal, 7, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g));
impl_reduce_by_tuple_key_sova2_values!(SoVA8 -> SoA8, reduce_tuple8_by_key_device_vec, Tuple8Equal, 8, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h));
impl_reduce_by_tuple_key_sova2_values!(SoVA9 -> SoA9, reduce_tuple9_by_key_device_vec, Tuple9Equal, 9, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i));
impl_reduce_by_tuple_key_sova2_values!(SoVA10 -> SoA10, reduce_tuple10_by_key_device_vec, Tuple10Equal, 10, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j));
impl_reduce_by_tuple_key_sova2_values!(SoVA11 -> SoA11, reduce_tuple11_by_key_device_vec, Tuple11Equal, 11, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k));
impl_reduce_by_tuple_key_sova2_values!(SoVA12 -> SoA12, reduce_tuple12_by_key_device_vec, Tuple12Equal, 12, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k, L: l: out_l));

macro_rules! impl_reduce_by_tuple_key_sova3_values {
    (
        $keys:ident -> $out_keys:ident,
        $reduce_fn:ident,
        $eq:ident,
        ...
        impl<ValueA, ValueB, ValueC, $first, $( $key ),+, KeyEq, Op>
            ReduceByKeyCall<SoVA3<ValueA, ValueB, ValueC>, KeyEq, Op> for $keys<$first, $( $key ),+>
        where
            Self: SoVA<Scalar = <$first as KernelColumn>::Item>,
            SoVA3<ValueA, ValueB, ValueC>:
                SoVA<Item = (ValueA::Item, ValueB::Item, ValueC::Item), Scalar = ValueA::Item>,
...
impl_reduce_by_tuple_key_sova3_values!(SoVA4 -> SoA4, reduce_tuple4_by_key_device_vec, Tuple4Equal, 4, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d));
impl_reduce_by_tuple_key_sova3_values!(SoVA5 -> SoA5, reduce_tuple5_by_key_device_vec, Tuple5Equal, 5, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e));
impl_reduce_by_tuple_key_sova3_values!(SoVA6 -> SoA6, reduce_tuple6_by_key_device_vec, Tuple6Equal, 6, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f));
impl_reduce_by_tuple_key_sova3_values!(SoVA7 -> SoA7, reduce_tuple7_by_key_device_vec, Tuple7Equal, 7, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g));
impl_reduce_by_tuple_key_sova3_values!(SoVA8 -> SoA8, reduce_tuple8_by_key_device_vec, Tuple8Equal, 8, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h));
impl_reduce_by_tuple_key_sova3_values!(SoVA9 -> SoA9, reduce_tuple9_by_key_device_vec, Tuple9Equal, 9, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i));
impl_reduce_by_tuple_key_sova3_values!(SoVA10 -> SoA10, reduce_tuple10_by_key_device_vec, Tuple10Equal, 10, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j));
impl_reduce_by_tuple_key_sova3_values!(SoVA11 -> SoA11, reduce_tuple11_by_key_device_vec, Tuple11Equal, 11, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k));
impl_reduce_by_tuple_key_sova3_values!(SoVA12 -> SoA12, reduce_tuple12_by_key_device_vec, Tuple12Equal, 12, (A: a: out_a, B: b: out_b, C: c: out_c, D: d: out_d, E: e: out_e, F: f: out_f, G: g: out_g, H: h: out_h, I: i: out_i, J: j: out_j, K: k: out_k, L: l: out_l));

macro_rules! impl_reduce_by_tuple_key_sova_values {
    ...
    (@reduce_values $reduce_fn:ident, $eq:ident, $value_index:tt, ($first_field:ident, $( $field:ident ),+), ($first:ident, $( $key:ident ),+), $init:ident, $value_ty:ident: $value_field:ident: $idx:tt $(, $tail_ty:ident: $tail_field:ident: $tail_idx:tt )*) => {
        let $value_field = impl_reduce_by_tuple_key_sova_values!(
            @reduce $reduce_fn,
            $eq,
            ($first_field, $( $field ),+),
            $value_ty,
        ...
        impl_reduce_by_tuple_key_sova_values!(
    ...
    (
            ...
            $( Op: BinaryOp<<$value as KernelColumn>::Item>, )+
        {
            ...
            fn reduce_by_key_call(
                ...
                let ($first_out, $( $out_field, )+ $first_value_field) = impl_reduce_by_tuple_key_sova_values!(
                    @reduce $reduce_fn,
                    KeyEq,
                    ($first_field, $( $field ),+),
                    $first_value,
...
macro_rules! impl_reduce_by_tuple_key_sova_values_for_key {
    ($key_storage:ident, $keys:ident -> $out_keys:ident, $reduce_fn:ident, $eq:ident, $value_index:tt, ( $first:ident: $first_field:ident: $first_out:ident, $( $key:ident: $field:ident: $out_field:ident ),+ )) => {
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA4 -> SoA4<A: 0, B: 1, C: 2, D: 3> { a, b, c, d }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA5 -> SoA5<A: 0, B: 1, C: 2, D: 3, E: 4> { a, b, c, d, e }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA6 -> SoA6<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5> { a, b, c, d, e, f }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA7 -> SoA7<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6> { a, b, c, d, e, f, g }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA8 -> SoA8<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7> { a, b, c, d, e, f, g, h }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA9 -> SoA9<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8> { a, b, c, d, e, f, g, h, i }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA10 -> SoA10<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9> { a, b, c, d, e, f, g, h, i, j }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA11 -> SoA11<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10> { a, b, c, d, e, f, g, h, i, j, k }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoVA, SoVA12 -> SoA12<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10, L: 11> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA2 -> SoA2<A: 0, B: 1> { left, right }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA3 -> SoA3<A: 0, B: 1, C: 2> { first, second, third }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA4 -> SoA4<A: 0, B: 1, C: 2, D: 3> { a, b, c, d }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA5 -> SoA5<A: 0, B: 1, C: 2, D: 3, E: 4> { a, b, c, d, e }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA6 -> SoA6<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5> { a, b, c, d, e, f }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA7 -> SoA7<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6> { a, b, c, d, e, f, g }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA8 -> SoA8<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7> { a, b, c, d, e, f, g, h }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA9 -> SoA9<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8> { a, b, c, d, e, f, g, h, i }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA10 -> SoA10<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9> { a, b, c, d, e, f, g, h, i, j }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA11 -> SoA11<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10> { a, b, c, d, e, f, g, h, i, j, k }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
        impl_reduce_by_tuple_key_sova_values!($key_storage, SoA, SoA12 -> SoA12<A: 0, B: 1, C: 2, D: 3, E: 4, F: 5, G: 6, H: 7, I: 8, J: 9, K: 10, L: 11> { a, b, c, d, e, f, g, h, i, j, k, l }, $keys -> $out_keys, $reduce_fn, $eq, $value_index, ( $first: $first_field: $first_out, $( $key: $field: $out_field ),+ ));
    };
}

impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA2 -> SoA2, reduce_tuple2_by_key_device_vec, Tuple2Equal, 2, (KA: left: out_left, KB: right: out_right));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA3 -> SoA3, reduce_tuple3_by_key_device_vec, Tuple3Equal, 3, (KA: first: out_first, KB: second: out_second, KC: third: out_third));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA4 -> SoA4, reduce_tuple4_by_key_device_vec, Tuple4Equal, 4, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA5 -> SoA5, reduce_tuple5_by_key_device_vec, Tuple5Equal, 5, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA6 -> SoA6, reduce_tuple6_by_key_device_vec, Tuple6Equal, 6, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA7 -> SoA7, reduce_tuple7_by_key_device_vec, Tuple7Equal, 7, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA8 -> SoA8, reduce_tuple8_by_key_device_vec, Tuple8Equal, 8, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA9 -> SoA9, reduce_tuple9_by_key_device_vec, Tuple9Equal, 9, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA10 -> SoA10, reduce_tuple10_by_key_device_vec, Tuple10Equal, 10, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA11 -> SoA11, reduce_tuple11_by_key_device_vec, Tuple11Equal, 11, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j, KK: k: out_k));
impl_reduce_by_tuple_key_sova_values_for_key!(SoVA, SoVA12 -> SoA12, reduce_tuple12_by_key_device_vec, Tuple12Equal, 12, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j, KK: k: out_k, KL: l: out_l));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA2 -> SoA2, reduce_tuple2_by_key_device_vec, Tuple2Equal, 2, (KA: left: out_left, KB: right: out_right));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA3 -> SoA3, reduce_tuple3_by_key_device_vec, Tuple3Equal, 3, (KA: first: out_first, KB: second: out_second, KC: third: out_third));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA4 -> SoA4, reduce_tuple4_by_key_device_vec, Tuple4Equal, 4, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA5 -> SoA5, reduce_tuple5_by_key_device_vec, Tuple5Equal, 5, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA6 -> SoA6, reduce_tuple6_by_key_device_vec, Tuple6Equal, 6, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA7 -> SoA7, reduce_tuple7_by_key_device_vec, Tuple7Equal, 7, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA8 -> SoA8, reduce_tuple8_by_key_device_vec, Tuple8Equal, 8, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA9 -> SoA9, reduce_tuple9_by_key_device_vec, Tuple9Equal, 9, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA10 -> SoA10, reduce_tuple10_by_key_device_vec, Tuple10Equal, 10, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA11 -> SoA11, reduce_tuple11_by_key_device_vec, Tuple11Equal, 11, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j, KK: k: out_k));
impl_reduce_by_tuple_key_sova_values_for_key!(SoA, SoA12 -> SoA12, reduce_tuple12_by_key_device_vec, Tuple12Equal, 12, (KA: a: out_a, KB: b: out_b, KC: c: out_c, KD: d: out_d, KE: e: out_e, KF: f: out_f, KG: g: out_g, KH: h: out_h, KI: i: out_i, KJ: j: out_j, KK: k: out_k, KL: l: out_l));
