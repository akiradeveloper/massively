...
- exclusive_scan_by_key(keys: &[]m, values: &[]n, eq: m->m->bool, zero: n, sum: n->n->n)
- find_first_of(xs: &[]n, needles: &[]n) -> int?
- find_if(xs: &[]n, p: n->bool) -> int?
- gather(xs: &[]n, indices: &[int]) -> []n
- gather_if(xs: &[]n, indices: &[int], p: n->bool) -> []n
- inclusive_scan(xs: &[]n, op: n->n->n) -> []n
- inclusive_scan_by_key(keys: &[]m, values: &[]n, eq: m->m->bool, sum: n->n->n)
- inner_product(xs: &[]n, ys: &[]m, zipper: n->m->l, zero: l, sum: l->l->l) -> l
- is_partitioned(xs: &[]n, p: n->bool) -> bool
- is_sorted_until(xs: &[]n, p: n->n->bool) -> int
- is_sorted(xs: &[]n, p: n->n->bool) -> bool
- lexicographical_compare(xs: &[]n, ys: &[]n, cmp: n->n->bool) -> bool
- lower_bound(xs: &[]n, cmp: n->n->bool) -> int
...
- replace_if(xs: &[]n, v: n, p: n->bool) -> []n
- reverse(xs: &[]n) -> []n
- scatter(xs: &[]n, indices: &[int], init: n) -> []n
- scatter_if(xs: &[]n, indices: &[int], init: n, p: n->bool) -> []n
