...
\begin{enumerate}
  ...
  \item kernel-checked counterparts of the foundational results in Lean~4;
  \item differential conformance tests between Lean-evaluated cases and the
        public \texttt{massively::graph} implementation.
\end{enumerate}
...
about the mathematical model without assuming that the implementation is
correct.  Keeping these claims distinct is essential to making later results
auditable.
