...
The introductory row-sequence model uses natural-number identifiers and assigns
no meaning to an invalid graph or to a frontier identifier outside $V$; its
Lean functions remain total.  The completeness model uses the type
\texttt{Fin $n$} for every vertex reference instead.  Valid sources,
