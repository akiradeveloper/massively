    ...
    detail::{
        api::{
            ...
            ordering::{
                ...
                tuple3_membership_expr_flags_with_policy, tuple4_membership_expr_flags_with_policy,
                tuple5_membership_expr_flags_with_policy, tuple6_membership_expr_flags_with_policy,
...
impl SetMembershipControlApply {
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::detail) fn tuple4_membership_expr_flags_with_policy<
        CandidateA,
        CandidateB,
        CandidateC,
        CandidateD,
    ...
    where
        ...
        CandidateB: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateC: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateD: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        SortedA: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateA::Item>
            + KernelColumnAt<S0>,
        SortedB: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateB::Item>
            + KernelColumnAt<S0>,
        SortedC: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateC::Item>
            + KernelColumnAt<S0>,
        SortedD: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateD::Item>
            + KernelColumnAt<S0>,
        CandidateA::Item: CubePrimitive + CubeElement,
        CandidateB::Item: CubePrimitive + CubeElement,
        CandidateC::Item: CubePrimitive + CubeElement,
        CandidateD::Item: CubePrimitive + CubeElement,
        CandidateA::Expr: DeviceGpuExpr<CandidateA::Item>,
        CandidateB::Expr: DeviceGpuExpr<CandidateB::Item>,
        CandidateC::Expr: DeviceGpuExpr<CandidateC::Item>,
        CandidateD::Expr: DeviceGpuExpr<CandidateD::Item>,
        SortedA::Expr: DeviceGpuExpr<SortedA::Item>,
        SortedB::Expr: DeviceGpuExpr<SortedB::Item>,
        SortedC::Expr: DeviceGpuExpr<SortedC::Item>,
        SortedD::Expr: DeviceGpuExpr<SortedD::Item>,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::detail) fn tuple5_membership_expr_flags_with_policy<
        CandidateA,
        CandidateB,
        CandidateC,
        CandidateD,
    ...
    where
        ...
        CandidateC: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateD: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateE: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        SortedA: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateA::Item>
            + KernelColumnAt<S0>,
        SortedB: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateB::Item>
            + KernelColumnAt<S0>,
        ...
        SortedD: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateD::Item>
            + KernelColumnAt<S0>,
        SortedE: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateE::Item>
            + KernelColumnAt<S0>,
        CandidateA::Item: CubePrimitive + CubeElement,
        CandidateB::Item: CubePrimitive + CubeElement,
        CandidateC::Item: CubePrimitive + CubeElement,
        CandidateD::Item: CubePrimitive + CubeElement,
        CandidateE::Item: CubePrimitive + CubeElement,
        CandidateA::Expr: DeviceGpuExpr<CandidateA::Item>,
        CandidateB::Expr: DeviceGpuExpr<CandidateB::Item>,
        CandidateC::Expr: DeviceGpuExpr<CandidateC::Item>,
        CandidateD::Expr: DeviceGpuExpr<CandidateD::Item>,
        CandidateE::Expr: DeviceGpuExpr<CandidateE::Item>,
        SortedA::Expr: DeviceGpuExpr<SortedA::Item>,
        SortedB::Expr: DeviceGpuExpr<SortedB::Item>,
        SortedC::Expr: DeviceGpuExpr<SortedC::Item>,
        SortedD::Expr: DeviceGpuExpr<SortedD::Item>,
        SortedE::Expr: DeviceGpuExpr<SortedE::Item>,
        Less: BinaryPredicateOp<(
            CandidateA::Item,
            CandidateB::Item,
            CandidateC::Item,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::detail) fn tuple6_membership_expr_flags_with_policy<
        CandidateA,
        CandidateB,
        CandidateC,
        CandidateD,
    ...
    where
        ...
        CandidateD: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateE: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateF: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        SortedA: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateA::Item>
            + KernelColumnAt<S0>,
        SortedB: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateB::Item>
            + KernelColumnAt<S0>,
        ...
        SortedE: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateE::Item>
            + KernelColumnAt<S0>,
        SortedF: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateF::Item>
            + KernelColumnAt<S0>,
        CandidateA::Item: CubePrimitive + CubeElement,
        CandidateB::Item: CubePrimitive + CubeElement,
        CandidateC::Item: CubePrimitive + CubeElement,
        CandidateD::Item: CubePrimitive + CubeElement,
        CandidateE::Item: CubePrimitive + CubeElement,
        CandidateF::Item: CubePrimitive + CubeElement,
        CandidateA::Expr: DeviceGpuExpr<CandidateA::Item>,
        CandidateB::Expr: DeviceGpuExpr<CandidateB::Item>,
        CandidateC::Expr: DeviceGpuExpr<CandidateC::Item>,
        CandidateD::Expr: DeviceGpuExpr<CandidateD::Item>,
        CandidateE::Expr: DeviceGpuExpr<CandidateE::Item>,
        CandidateF::Expr: DeviceGpuExpr<CandidateF::Item>,
        SortedA::Expr: DeviceGpuExpr<SortedA::Item>,
        SortedB::Expr: DeviceGpuExpr<SortedB::Item>,
        SortedC::Expr: DeviceGpuExpr<SortedC::Item>,
        SortedD::Expr: DeviceGpuExpr<SortedD::Item>,
        SortedE::Expr: DeviceGpuExpr<SortedE::Item>,
        SortedF::Expr: DeviceGpuExpr<SortedF::Item>,
        Less: BinaryPredicateOp<(
            CandidateA::Item,
            CandidateB::Item,
            CandidateC::Item,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::detail) fn tuple7_membership_expr_flags_with_policy<
        CandidateA,
        CandidateB,
        CandidateC,
        CandidateD,
    ...
    where
        ...
        CandidateE: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateF: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        CandidateG: KernelColumn<Runtime = CandidateA::Runtime> + KernelColumnAt<S0>,
        SortedA: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateA::Item>
            + KernelColumnAt<S0>,
        SortedB: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateB::Item>
            + KernelColumnAt<S0>,
        ...
        SortedF: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateF::Item>
            + KernelColumnAt<S0>,
        SortedG: KernelColumn<Runtime = CandidateA::Runtime, Item = CandidateG::Item>
            + KernelColumnAt<S0>,
        CandidateA::Item: CubePrimitive + CubeElement,
        CandidateB::Item: CubePrimitive + CubeElement,
        CandidateC::Item: CubePrimitive + CubeElement,
        ...
        CandidateE::Item: CubePrimitive + CubeElement,
        CandidateF::Item: CubePrimitive + CubeElement,
        CandidateG::Item: CubePrimitive + CubeElement,
        CandidateA::Expr: DeviceGpuExpr<CandidateA::Item>,
        CandidateB::Expr: DeviceGpuExpr<CandidateB::Item>,
        CandidateC::Expr: DeviceGpuExpr<CandidateC::Item>,
        CandidateD::Expr: DeviceGpuExpr<CandidateD::Item>,
        CandidateE::Expr: DeviceGpuExpr<CandidateE::Item>,
        CandidateF::Expr: DeviceGpuExpr<CandidateF::Item>,
        CandidateG::Expr: DeviceGpuExpr<CandidateG::Item>,
        SortedA::Expr: DeviceGpuExpr<SortedA::Item>,
        SortedB::Expr: DeviceGpuExpr<SortedB::Item>,
        SortedC::Expr: DeviceGpuExpr<SortedC::Item>,
        SortedD::Expr: DeviceGpuExpr<SortedD::Item>,
        SortedE::Expr: DeviceGpuExpr<SortedE::Item>,
        SortedF::Expr: DeviceGpuExpr<SortedF::Item>,
        SortedG::Expr: DeviceGpuExpr<SortedG::Item>,
        Less: BinaryPredicateOp<(
            CandidateA::Item,
            CandidateB::Item,
            CandidateC::Item,
