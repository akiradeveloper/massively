...
pub(crate) use api::{
    ...
    partition, reduce, reduce_by_key, remove_if, replace_where, reverse, set_difference,
    set_intersection, set_union, sort, sort_by_key, unique, unique_by_key, upper_bound,
};
