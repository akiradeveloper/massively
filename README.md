...
The library is organized around two public layers.

- `runtime` prepares the execution backend, transfers data, allocates device
  memory, and exposes `Executor`, `DeviceVec`, `DeviceSlice`, and
  `DeviceSliceMut`.
